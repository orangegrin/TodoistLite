...
namespace TodoistLite
{
    ...
    public partial class MainWindow : Window
    {
        ...
        {
            mWebBrowser.Address = "https://todoist.com/app";
            var margin = 5;
        ...
        {
            mDelay = Task.Delay(300);
            await mDelay;
            if(mDelay != null && mDelay.IsCompleted)
                SetBottom(this);
        }
        ...
        private void SetBottom(Window window)
        {
            ...
            Background = new SolidColorBrush(Colors.Black) { Opacity = 0 };
            mWebBrowser.Opacity = 0.3;
        }

        private void SetTopMost(Window window)
        {
            Background = new SolidColorBrush(Colors.Black) { Opacity = 0 };
            mWebBrowser.Opacity = 1;
            IntPtr hWnd = new WindowInteropHelper(window).Handle;
